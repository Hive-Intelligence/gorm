...
type Schema struct {
	...
	BeforeUpdate, GormUpdating, AfterUpdate bool
...
func Parse(dest interface{}, cacheStore *sync.Map, namer Namer) (*Schema, error) {
	...
	tableName := namer.TableName(modelType)
	...
	callbacks := []string{"BeforeCreate", "AfterCreate", "BeforeUpdate", "GormUpdating", "AfterUpdate", "BeforeSave", "AfterSave", "BeforeDelete", "AfterDelete", "AfterFind"}
